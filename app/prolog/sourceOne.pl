...
hasGoalName(GOAL,NAME):-hasCondition(GOAL,CONDITION),hasName(CONDITION,NAME).
...
hasNameConditionMission(missao0,procedimentos-iniciais).
...
hasNameConditionMission(missao02,teste-impedancia-corda).
...
hasNameConditionMission(missao08,retirar-bastao-garra).

hasNameConditionMission(missao09,procedimentos-iniciais).
hasNameConditionMission(missao09,metodo-a-distancia).
...
hasNameConditionMission(missao09,objetivo-final).
hasNameConditionMission(missao09,etapas-metodologicas).
hasNameConditionMission(missao09,metodo-finalizado).
